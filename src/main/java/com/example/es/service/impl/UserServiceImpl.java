...
public class UserServiceImpl implements UserService {
    ...
    public void save(List<User> list) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            User user = new User(i, names[i1], i, String.valueOf(i % 2), descArr[i2]);
    ...
    public List<User> findByName(String text) {
        return userDao.findByName(text);
    }
    ...
    public List<User> findByNameOrDesc(String name, String desc) {
        return userDao.findByNameOrDesc(name,desc);
    }

    @Override
    public  List<User> findByDesc(String desc) {
        return userDao.findByDesc(desc);
    }

    @Override
    public User findById(long id) {
        Optional<User> beans = userDao.findById(id);
        return beans.orElse(null);
    }
}
